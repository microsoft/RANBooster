...
ip link set dev enp63s0np0 mtu 3300
ip link set dev enp63s0v0 mtu 3300
ip link set dev enp63s0v1 mtu 3300
ip link set dev enp63s0v2 mtu 3300
ip link set dev enp63s0v3 mtu 3300
...
ethtool -L enp63s0v2 combined 1
ethtool -L enp63s0v3 combined 1
ethtool -L enp63s0v4 combined 1
